...
from sklearn.externals import joblib#col names for test data
...
print(Style.BRIGHT,Fore.GREEN,df.head())
...
print(Style.BRIGHT,Fore.GREEN+'Positives - {}'.format(pos))
print(Style.RESET_ALL)
print(Style.BRIGHT,Fore.RED+'Negatives - {}'.format(neg))
print(Style.RESET_ALL)
...
print(Style.BRIGHT,Fore.CYAN+'accuracy score: {0:.2f}%'.format(accuracy_score(y_test, y_preds)*100))
print(Style.RESET_ALL+'\n')
print('confusion matrix: \n',confusion_matrix(y_test,y_preds))
print('\n')
print("-"*80)
print("classification report")
print(Style.BRIGHT,Fore.YELLOW,classification_report(y_test, y_preds))

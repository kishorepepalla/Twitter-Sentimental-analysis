...
print(Style.BRIGHT,Fore.RED+"Report Section starts")
...
neg = df_tweet_preds.predictions.value_counts()[4]
...
names = ["Logistic Regression", "Linear SVC", "LinearSVC with L1-based feature selection","Multinomial NB",
         "Bernoulli NB", "Ridge Classifier", "AdaBoost", "Perceptron","Passive-Aggresive", "Nearest Centroid","RandomForest"]
classifiers = [
    LogisticRegression(),
    LinearSVC(),
    Pipeline([
...
labels = fin[0]
sizes = fin[1]
colors = ['gold', 'yellowgreen', 'lightcoral', 'lightskyblue','red','orange','blue','purple','green','black']
